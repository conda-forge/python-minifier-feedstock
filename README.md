...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-minifier-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14987&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-minifier-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-minifier` can be installed with:

```
conda install python-minifier
```

It is possible to list all of the versions of `python-minifier` available on your platform with:
